...
//    读取视频流
    ...
    while (av_read_frame(formatContext,avPacket)>=0){
        ...
        int ret = avcodec_receive_frame(avCodecContex,frame);
...
FfVideoPlay::FfVideoPlay(FfVideoPlayer *pPlayer) {
    this->ffVideoPlayer = pPlayer;
    this->video_stream_index = ffVideoPlayer->video_stream_index;
}
